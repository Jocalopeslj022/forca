...
conjuntos = {
    ...
    'animal': ['aguia', 'baleia', 'cavalo', 'doninha', 'elefante', 'foca', 'gato', 'hipopotamo', 'iguana', 'jacare', 'leao', 'macaco', 'naja', 'onca', 'panda', 'rato', 'sapo', 'tartaruga', 'urso', 'vaca', 'yak', 'zebra']
}
...
class JogoDaForca:
    ...
    def submeter_letra(self):
        ...
        # Verificar se a letra é válida (apenas letras minúsculas)
        if not re.match("^[a-z]$", letra):
            messagebox.showwarning("Entrada inválida", "Por favor, digite apenas letras minúsculas.")
            return
